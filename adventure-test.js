...
//Map houses the functions and module-2s
...
//module-2s
elementMap["contract"] = document.getElementsByClassName("module-2 contract")[0];
elementMap["procurement"] = document.getElementsByClassName("module-2 procurement")[0];
elementMap["organization"] = document.getElementsByClassName("module-2 organization")[0];
elementMap["core"] = document.getElementsByClassName("module-2 core")[0];
elementMap["panel"] = document.getElementsByClassName("module-2 panel")[0];
elementMap["report"] = document.getElementsByClassName("module-2 report")[0];
elementMap["analytics"] = document.getElementsByClassName("module-2 analytics")[0];
elementMap["financial"] = document.getElementsByClassName("module-2 financial")[0];
elementMap["landing-page"] = document.getElementsByClassName("module-2 landingpage")[0];
elementMap["portt-hub"] = document.getElementsByClassName("module-2 portt-hub")[0];
